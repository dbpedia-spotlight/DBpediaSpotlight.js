...
exports.annotate=function(input, cb, err) {
    ...
    var default_endpoints = {
      ...
      german     : { host: 'model.dbpedia-spotlight.org', path: '/de/annotate', port: '80', confidence: 0.5, support: 0 },
      dutch      : { host: 'model.dbpedia-spotlight.org', path: '/nl/annotate', port: '80', confidence: 0.5, support: 0 },
      hungarian  : { host: 'model.dbpedia-spotlight.org', path: '/hu/annotate', port: '80', confidence: 0.5, support: 0 },
      french     : { host: 'model.dbpedia-spotlight.org', path: '/fr/annotate', port: '80', confidence: 0.5, support: 0 },
      portuguese : { host: 'model.dbpedia-spotlight.org', path: '/pt/annotate', port: '80', confidence: 0.5, support: 0 },
      italian    : { host: 'model.dbpedia-spotlight.org', path: '/it/annotate', port: '80', confidence: 0.5, support: 0 },
      rusian     : { host: 'model.dbpedia-spotlight.org', path: '/ru/annotate', port: '80', confidence: 0.5, support: 0 },
      turkish    : { host: 'model.dbpedia-spotlight.org', path: '/tr/annotate', port: '80', confidence: 0.5, support: 0 },
      spanish    : { host: 'model.dbpedia-spotlight.org', path: '/es/annotate', port: '80', confidence: 0.5, support: 0 }
    };
